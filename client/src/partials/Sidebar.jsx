      ...
      >
        ...
        <div className="space-y-8">
          ...
          <div>
            ...
            {/* Dashboard  */}
              <li
                className="px-3 py-2 rounded-sm mb-0.5 
                "
              >
                <NavLink
                  end
              ...
              <li
                className={`px-3 py-2 rounded-sm mb-0.5 last:mb-0 ${
                  pathname.includes("platforms") && "bg-slate-900"
                }`}
              >
                <NavLink
                  end
              ...
              <li
                className={`px-3 py-2 rounded-sm mb-0.5 last:mb-0 ${
                  pathname.includes("community/polls") && "bg-slate-900"
                }`}
              >
                <NavLink
                  end
              ...
              <li
                className={`px-3 py-2 rounded-sm mb-0.5 last:mb-0 ${
                  pathname.includes("candidates") && "bg-slate-900"
                }`}
              >
                <NavLink
                  end
              ...
              <li
                className={`px-3 py-2 rounded-sm mb-0.5 last:mb-0 ${
                  pathname.includes("reviews") && "bg-slate-900"
                }`}
              >
                <NavLink
                  end
              ...
              <li
                className={`px-3 py-2 rounded-sm mb-0.5 last:mb-0 ${
                  pathname.includes("voting-analysis") && "bg-slate-900"
                }`}
              >
                <NavLink
                  end
                  to="/voting-analysis"
                  className={`block text-slate-200 truncate transition duration-150 ${
                    pathname.includes("voting-analysis")
                      ? "hover:text-slate-200"
                      : "hover:text-white"
                  }`}
                >
